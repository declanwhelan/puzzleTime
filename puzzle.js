...
(function() {
  ...
  Puzzle = (function() {
    ...
    Puzzle.prototype.blankPosition = function() {
      var place, _i, _ref;
      for (place = _i = 0, _ref = this.places.length; 0 <= _ref ? _i <= _ref : _i >= _ref; place = 0 <= _ref ? ++_i : --_i) {
        if (this.places[place]["class"] === 'Blank') {
          return place;
        }
      }
    };
    ...
    Puzzle.prototype.renderBoard = function() {
      ...
      $('#canvas').html('');
      if (this.checkIfWon()) {
        $('#canvas').append('<span id="windiv"><img src="' + this.image + '"/><div class="banner"> You Won!</div><div class="bubblegum"></div></span>');
